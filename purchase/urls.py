...
urlpatterns = (
    ...
    path("api/v1/update_quantity/<int:product_pk>/<str:order_type>/<int:quantity>/",
         api.UpdateQuantity.as_view()),
    ...
    path("api/v1/update_purchase_line/<int:product_pk>/<int:quantity>/",
         api.UpdatePurchaseLine.as_view()),
